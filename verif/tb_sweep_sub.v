...
// output.  Reads verif/sweep_sub_vec.csv (sid,A,B,C,D,Vth) -> verif/sweep_sub_rtl.csv.
...
module tb_sweep_sub;
    ...
    initial begin
        ...
        fo = $fopen("verif/sweep_sub_rtl.csv", "w");
        ...
        $fclose(fo);
        $display("SUB SWEEP DONE: %0d points -> verif/sweep_sub_rtl.csv", NV);
        $finish;
    end
endmodule
